...
import com.bankapi.model.Transacao;
import java.sql.*;
...
public class  TransacaoDAO {
    ...
    public void registrarTransacao(Transacao transacao) throws SQLException {
        ...
        String sql = "INSERT INTO transacao (conta_origem, conta_destino, valor, data_transacao) VALUES (?, ?, ?, ?)";
    ...
    private Transacao mapTransacao(ResultSet rs) throws SQLException {
        ...
        transacao.setContaOrigem(rs.getString("conta_origem"));
        transacao.setContaDestino(rs.getString("conta_destino"));
